...
class APIKeyForm(forms.Form):
    key_name = forms.CharField(label='Key Name (optional)', required=False, widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Enter key name'}))
...
class APIKeyListView(LoginRequiredMixin, ListView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            api_key, key = UserAPIKey.objects.create_key(name=form.cleaned_data['key_name'],
